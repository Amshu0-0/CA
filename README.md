...
## Running It
When rebuilding this on your own VMs, docker-compose.yml (Kafka) and both producer.py and processor.py read KAFKA_BROKER and MONGO_HOST from the environment, falling back to this deployment's private IPs (172.31.21.128, 172.31.24.111) if unset. Export your own before running if your VMs get different private IPs.
```
