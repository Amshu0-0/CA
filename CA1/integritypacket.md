...
- **Verified and used as-is:** the overall file layout (separating network/security/compute/key_pair into their own Terraform files; one Ansible role per pipeline component), and most Jinja2 templating syntax.
